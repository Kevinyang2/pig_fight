...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='ultralytics/cfg/models/v10/yolov10n-APconv.yaml', help='model.yaml')
    ...
    elif opt.profile:  # profile forward pass (simple timing)
