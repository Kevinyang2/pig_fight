...
parser.add_argument('--image_path', default='D:\googleDownload\pig_fight_DEC\\valid\images', type=str, help="path of images")
parser.add_argument('--label_path', default='D:\googleDownload\pig_fight_DEC\\valid\labels', type=str, help="path of labels .txt")
