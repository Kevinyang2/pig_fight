...
def parse_args():
    ...
    parser.add_argument('--weights', type=str, default='runs/train/v10-APConv-AssemFormer-HSFPN-ATFLm_exp/weights/best.pt', help='模型权重')
    parser.add_argument('--source', type=str, required=True, help='视频/图像/目录/通配符')
    parser.add_argument('--tracker', type=str, default='botsort.yaml', help='跟踪器配置：bytetrack.yaml 或 botsort.yaml（支持绝对路径）')
