...
if __name__ == '__main__':
    ...
    img_dir = '../../../data/MP3D/mp3d_train_10.29' # fill in the path to the image directory
    save_dir = '../../../data/MP3D/mp3d_train_10.2_dift' # fill in the path to the directory of saving the extracted features
    img_name_list = json.load(open('../../../data/MP3D/mp3d_train_10.2_dift.json')) # fill in the path to the image name list
