...
class DetectionWindow(QMainWindow):
    ...
    def __init__(self, username: str = "Guest") -> None:
        ...
        self.setWindowTitle(f"无人机驱动的避雷线断裂X射线图像检测系统 - 欢迎 {username}")
    ...
    def _build_side_panel(self) -> QFrame:
        ...
        user_name_label.setStyleSheet("color: #fed7aa; font-size: 16px; font-weight: 700;border-radius: 8px;padding: 4px 8px;")
        ...
        title = QLabel("无人机驱动的避雷线断裂X射线图像检测系统")
        title_font = QFont(self.font_family, 18, QFont.Bold)
        title.setFont(title_font)
        title.setStyleSheet("""
            color: qlineargradient(x1:0, y1:0, x2:1, y2:0,
                stop:0 #fed7aa, stop:0.5 #fb923c, stop:1 #f97316);
            letter-spacing: 0px;
        """)
        ...
        self.status_label.setStyleSheet("color: #fb923c; font-size: 13px; font-weight: 500;")
